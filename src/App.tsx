...
export const filterClearTemplate = (
  options: ColumnFilterClearTemplateOptions
) => {
  return <Button onClick={options.filterClearCallback}>x</Button>;
};

const FilterApplyButton: React.FC<{ onApply: () => void }> = ({ onApply }) => {
  return <Button onClick={onApply}>Apply</Button>;
};

export const filterApplyTemplate = (
  options: ColumnFilterApplyTemplateOptions
) => {
  return <FilterApplyButton onApply={options.filterApplyCallback} />;
};
